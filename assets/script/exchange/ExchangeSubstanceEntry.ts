...
@ccclass
export default class ExchangeSubstanceEntry extends BaseUI {
    //无货提示
    ...
    initButton(){
        ...
        this.setButtonClick("btm/btnBuy", () => {
            ...
            Helper.OpenPageUI("component/Exchange/ExchangeConfirmEntry", "确认订单", null, param)
        })
