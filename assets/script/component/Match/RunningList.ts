...
import GameItemTitle from "../Base/GameItemTitle";
...
export default class RunningList extends BaseUI {
    ...
    onPressDetail() {
        let title = this.getNodeComponent(this.node, GameItemTitle)
        this.setChildParam("popInfo/MatchRunningListEntry", this.node.parent.parent, { type: this.type, showAllList: true, title: title ? title.titleName : "" })
