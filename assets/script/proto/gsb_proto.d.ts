...
export namespace gsbase {
    ...
    class GsBase extends $protobuf.rpc.Service {
         ...
         * @param callback Node-style callback called with the error, if any, and JoinRoomRsp
         */
         ...
         * @returns Promise
         */
        public joinRoom(request: gsbase.IJoinRoomReq): Promise<gsbase.JoinRoomRsp>;

        /**
         * Calls LeaveRoom.
         * @param request LeaveRoomReq message or plain object
         * @param callback Node-style callback called with the error, if any, and LeaveRoomRsp
         */
         ...
         * @returns Promise
         */
        public leaveRoom(request: gsbase.ILeaveRoomReq): Promise<gsbase.LeaveRoomRsp>;
    }
    ...
    namespace GsBase {
         ...
         * @param [response] JoinRoomRsp
         */
        type JoinRoomCallback = (error: (Error|null), response?: gsbase.JoinRoomRsp) => void;

        /**
         * Callback as used by {@link gsbase.GsBase#leaveRoom}.
         * @param error Error, if any
         * @param [response] LeaveRoomRsp
         */
        type LeaveRoomCallback = (error: (Error|null), response?: gsbase.LeaveRoomRsp) => void;
    }
